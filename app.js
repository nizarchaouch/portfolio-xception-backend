...
const ModelPortfolioRouter = require("./routes/ModelPortfolioR");
const AdminRouter = require("./routes/adminR");
const NotifRouter = require("./routes/notificationR");
...
app.use("/api/ModelPortfolio", ModelPortfolioRouter);
